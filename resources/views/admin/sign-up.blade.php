...
<head>
    ...
    <link href="{{ asset('admin_asses/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="bg-body">
        ...
        ">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                ...
                <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form action="/admin/sign-up" method="POST" class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-10 text-center">
                            ...
                            <div class="text-gray-400 fw-bold fs-4">
                                ...
                                <a href="/admin/sign-in" class="link-primary fw-bolder">Sign in here</a>
                            </div>
                            <!--end::Link-->
                        </div>
                        <!--end::Heading-->
    ...
    <script src="{{ asset('admin_asset/js/custom/authentication/sign-up/general.js') }}"></script> --}}
